...
## Lokale events (localEvents)

Definieer globale functies die vanuit elk sjabloon aanroepbaar zijn:
...
Gebruik in het sjabloon (met de `$l.`-prefix):
...
Voeg aangepaste Jinja-filters toe via `Request.addLocalLayoutFilters`:
