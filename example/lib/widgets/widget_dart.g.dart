  ...
  <div>
    ...
    <div class="relative">
      ...
      <input
        ...
        class="block h-12 w-full rounded-lg border pl-10 pr-3 text-sm shadow-sm transition-all duration-200 {{ 'border-rose-500 bg-rose-50 text-rose-900 placeholder-rose-400 focus:border-rose-600 focus:ring-4 focus:ring-rose-500/30' if $n('form_login/email/failed') else 'border-gray-300 bg-white text-gray-900 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20' }}"
      />
    </div>
  ...
  <div>
    ...
    <div class="relative">
      ...
      <input
        ...
        class="block mb-4  h-12 w-full rounded-lg border pl-10 pr-3 text-sm shadow-sm transition-all duration-200 {{ 'border-rose-500 bg-rose-50 text-rose-900 placeholder-rose-400 focus:border-rose-600 focus:ring-4 focus:ring-rose-500/30' if $n('form_login/password/failed') else 'border-gray-300 bg-white text-gray-900 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20' }}"
      />
    </div>
...
<div class="space-y-6">
  <!-- Page Header -->
  <div class="flex items-center gap-3">
    <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-purple-400 to-purple-600 text-white shadow-lg">
      <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path>
      </svg>
    </div>
...
<html class="h-full overflow-x-hidden">
  ...
  <body class="bg-gray-50 font-serif antialiased overflow-x-hidden">
    <div class="flex items-center justify-center p-4" style="min-height: 50vh;">
      <div class="bg-white rounded-lg p-8 shadow-lg" style="width: 500px; line-height: 1.6;">
        <!-- Markdown Title -->
        <h1 class="text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-gray-300">MCP Server (Example)</h1>
        
        <!-- Markdown Content -->
        <div class="space-y-6 text-gray-800">
          <div>
            <p class="text-sm font-semibold text-gray-900 mb-2">Link:</p>
            <code class="block w-full bg-gray-100 px-3 py-2 rounded text-sm font-mono break-all">{{ url }}</code>
          </div>
          <div>
            <p class="text-sm font-semibold text-gray-900 mb-2">Type:</p>
            <code class="block w-full bg-gray-100 px-3 py-2 rounded text-sm font-mono">{{ type }}</code>
          </div>
          <div>
            <p class="text-sm font-semibold text-gray-900 mb-2">API Key:</p>
            <code class="block w-full bg-gray-100 px-3 py-2 rounded text-sm font-mono break-all">{{ apikey }}</code>
          </div>
        </div>
      </div>
    </div>
